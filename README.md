# 🧑‍💼 Apad Management System

Sistema base para controle e gerenciamento de usuários, incluindo autenticação, permissões por cargo, CRUD de pessoas vinculadas a usuários, controle de animais, eventos, campanhas e suporte a tema escuro 🌙.
